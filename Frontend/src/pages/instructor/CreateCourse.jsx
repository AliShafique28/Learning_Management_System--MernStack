...
const CreateCourse = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate(`/instructor/manage-course/${newCourse._id}`);
    } catch (error) {
        ...
        <div className="space-y-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-sm text-blue-800">
              <strong>Note:</strong> After creating the course, you'll be able to add modules, lessons,
              quizzes, and assignments in the course management page.
            </p>
          </div>
        </div>
